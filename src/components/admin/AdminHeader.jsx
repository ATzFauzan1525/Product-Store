...
import { TrendingUp, Package, Box, DollarSign, LogOut } from 'lucide-react';

export default function AdminHeader({ totalProducts = 0, totalStock = 0, inventoryValue = 0, onLogout }) {
  return (
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-white bg-opacity-15 backdrop-blur-md px-6 py-4 rounded-xl border border-white border-opacity-20">
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-sm text-purple-100 font-medium">Total Produk</p>
            </div>
          ...
          <div className="bg-white bg-opacity-15 backdrop-blur-md px-6 py-4 rounded-xl border border-white border-opacity-20">
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-sm text-purple-100 font-medium">Nilai Inventori</p>
            </div>
